...
import { getRecentActivities, getUserActivities, type Activity, getUserData, type UserData } from "@/lib/firestore"
                ...
                <div key={activity.id} className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-sm font-medium leading-none">
                      <span className="font-semibold">{userData?.displayName || userData?.email.split("@")[0]}</span>{" "}
