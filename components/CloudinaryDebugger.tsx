...
export default function CloudinaryDebugger() {
  ...
  const testMinimalUpload = async () => {
    ...
    try {
      ...
      addLog(`❌ Minimal upload failed: ${error instanceof Error ? error.message : String(error)}`)
    }
  }
  ...
  const testWithHeaders = async () => {
    ...
    try {
      ...
      addLog(`❌ Headers test failed: ${error instanceof Error ? error.message : String(error)}`)
    }
  }
  ...
  const testResourceEndpoint = async () => {
    ...
    try {
      ...
      addLog(
        `❌ Resource endpoint test failed: ${error instanceof Error ? error.message : String(error)}`
      )
    }
  }
  ...
  const testFileUpload = async (file: File) => {
    ...
    try {
      ...
      addLog(`❌ File upload failed: ${error instanceof Error ? error.message : String(error)}`)
    }
  }
