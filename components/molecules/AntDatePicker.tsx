...
export function DatePicker({
  ...
  return (
    <AntDatePicker
      size={size}
      value={value ? dayjs(value instanceof Timestamp ? value.toDate() : value) : null}
...
export function RangePicker({
  ...
  const dayjsValue = value
    ? ([value[0] ? dayjs(value[0]) : null, value[1] ? dayjs(value[1]) : null] as [
        Dayjs | null,
        Dayjs | null,
      ])
    : null
...
interface CombinedDatePickerProps extends Omit<BaseAntDatePickerProps, 'placeholder'> {
  mode?: DatePickerMode
