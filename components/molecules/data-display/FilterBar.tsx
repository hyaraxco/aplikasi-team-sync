...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  const hasActiveFilters =
    Object.values(filters).some(arr => arr.length > 0) || searchTerm.length > 0
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end' className='w-48'>
              ...
              {sortOptions.map(opt => (
                ...
                >
                  {sortField === opt.id && <span className='mr-2 text-primary'>✔</span>}
                  {opt.label}
                  {sortField === opt.id && (
              ...
              >
                {sortDirection === 'asc' && <span className='mr-2 text-primary'>✔</span>}
                Ascending
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              >
                {sortDirection === 'desc' && <span className='mr-2 text-primary'>✔</span>}
                Descending
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
