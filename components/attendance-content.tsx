...
import { CalendarIcon, Clock, LogIn, LogOut, Info } from "lucide-react";
import {
...
export function AttendanceContent() {
  ...
  const handleCheckOut = async () => {
    if (!user || !todaysAttendance || !todaysAttendance.id || !canClockOut)
      return;
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <Tabs defaultValue="my_records" className="space-y-4">
        <TabsList>
          {userRole === "admin" && (
            <TabsTrigger value="all_records">All Employees</TabsTrigger>
          )}
          <TabsTrigger value="my_records">
          ...
          <TabsContent value="all_records" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  View attendance records from all employees.
                </CardDescription>
              </CardHeader>
              <CardContent>
