/**
 * @fileoverview UI-related type definitions for Team Sync application
 *
 * This module contains type definitions for UI components, filtering, sorting,
 * styling, and user interface interactions.
 *
