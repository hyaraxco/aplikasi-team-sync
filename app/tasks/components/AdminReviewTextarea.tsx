...
interface AdminReviewTextareaProps {
  initialValue: string
...
export const AdminReviewTextarea = memo(function AdminReviewTextarea({
  initialValue,
  onChange,
  disabled,
  taskId,
}: AdminReviewTextareaProps) {
  ...
  return (
    <Textarea
      ref={textareaRef}
      id='review-comment'
      placeholder='Add your feedback and review notes...'
      value={internalValue}
