      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="space-y-1">
            ...
            <p>
              {typeof budgetInfo === "number"
                ? `Rp${budgetInfo.toLocaleString()}`
                : "-"}
            </p>
          </div>
          <div className="space-y-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="space-y-1">
            ...
            <div>
              {priorityInfo ? <BadgePriority priority={priorityInfo} /> : "-"}
            </div>
          </div>
          <div className="space-y-1">
            <h3 className="text-sm font-medium text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {startDateInfo
                  ? format(new Date(startDateInfo), "MMM d, yyyy")
                  : "-"}
              </span>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                {deadlineInfo
                  ? format(new Date(deadlineInfo), "MMM d, yyyy")
                  : "-"}
              </span>
            </div>
          </div>
