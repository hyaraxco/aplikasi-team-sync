...
import type { ProjectMetrics, TeamMetrics } from "@/lib/firestore";
...
export function ProjectStatsCard({
  ...
  const projectCompletionPercentage =
    totalProjectsCount > 0
      ? (completedProjectsCount / totalProjectsCount) * 100
      : 0;
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <div className="flex justify-between mb-1">
            ...
            <span className="text-sm font-medium">
              {averageProjectProgress.toFixed(0)}%
            </span>
          </div>
          <Progress
        ...
        <div>
          ...
          <Progress
            value={
              totalMembersCount > 0
                ? (activeMembersCount / totalMembersCount) * 100
                : 0
            }
