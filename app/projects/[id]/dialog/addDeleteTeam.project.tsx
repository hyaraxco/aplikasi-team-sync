    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-lg max-h-[90dvh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Add teams to the project to collaborate with them.
          </DialogDescription>
        </DialogHeader>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Are you sure you want to remove {teamName ?? "team"} from this
            project?
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            The team itself will not be deleted, only unlinked from this
            project.
          </p>
